# The Crayon Crew — Character Cast
...
- Compact young woman with charcoal hair in a high messy bun; a small pencil (often marigold) stuck through the bun.
- Large round charcoal-rimmed glasses. Round friendly face, tiny charcoal dot eyes, small confident smile, marigold blush cheek dots.
- Boxy warm-white top with wide black-and-white horizontally striped sleeves.
...
- Soft-bodied, round-faced person with short fluffy charcoal curls and one springy cowlick sticking up.
- Tiny charcoal dot eyes, tiny smile, marigold blush cheek dots, cozy relaxed posture. Sleepy half-lidded eyes are fine when zoning out.
...
- Narrow oval face with a slightly pointed chin, tiny charcoal dot eyes, warm composed closed-mouth smile, marigold blush cheek dots. No glasses.
- Sleek charcoal hair (straight to lightly wavy) in a low side-ponytail tied with a marigold ribbon bow.
- Marigold-yellow boxy short-sleeve blouse with a small warm-white rounded / Peter Pan collar.
...
- Petite, small-framed person — the smallest human of the crew.
- Warm cream / pale hair with straight blunt bangs, worn in two long thick braids that reach the floor and often coil around the feet.
- Small heart-shaped face, tiny nose, gentle peaceful smile, marigold blush cheek dots — usually with serene closed curved-lash eyes; open eyes when the moment needs sharper focus.
- Big charcoal over-ear headphones with marigold ear cushions / accents, worn over the hair.
...
The one who fixes, assembles, and keeps the machinery running.

- Short, stocky, friendly middle-aged man with a bushy charcoal handlebar mustache, a round nose, tiny charcoal dot eyes, and marigold blush cheek dots.
- Short curly charcoal hair visible under the cap at the sides / ears.
- Flat marigold-yellow cap.
- Warm-white long-sleeve shirt with large bold black polka dots; sleeves rolled to the elbows.
...
The brilliant inventor — Iron Man energy without the suit. Charismatic, a little cocky, always building or demoing the next gadget.

- Athletic medium build. Short styled charcoal hair, a thin charcoal goatee and mustache, tiny charcoal dot eyes, confident smirk, marigold blush cheek dots.
...
Do NOT default Spark for: debugging, refactoring, maintenance, research, filtering context, writing, publishing, automation, or being stuck with tools. Those belong to other crew (see casting rules).

## Milo — the explorer

The one who searches, investigates, and follows the trail.

- Tall, lanky young man with short curly charcoal hair, tiny charcoal dot eyes, a calm curious smile, and marigold blush cheek dots.
- Small marigold neckerchief knotted at the throat.
- Boxy long-sleeve sweater with a bold black-and-white zigzag / chevron pattern.
...
- Small-to-medium scruffy terrier-like dog with a warm-white shaggy coat and large irregular marigold patches on the body / tail.
- Floppy ears (charcoal, or mixed charcoal and cream), charcoal nose, simple charcoal dot eyes, cheerful expression.
...
- Often sits, lies, or trots beside another crew member — alone only when the shot is specifically about automation / fetch.

Best for: fetching, transporting, automation, the "tool that does the work," comic relief in group scenes.

## Casting rules

- One or two characters per image is the default. Use the full crew only for "team," "community," or celebratory finale images.
- Match the character to the **action**, not the topic domain. A tech or AI article is not automatically Spark's job.
- **Tech-topic rotation:** when the article is about AI, tools, engineering, or software, still cast by the cognitive move:
  - inventing / demoing a prototype → **Spark**
  - fixing / assembling / maintaining systems → **Otto**
  - searching / tracing / investigating a bug or path → **Milo**
  - creating / drafting / shipping the work itself → **Penny**
  - thinking / stuck / reacting to the tool → **Fern**
  - listening / filtering / gathering signal → **Echo**
  - delivering / publishing / handing off → **Margo**
  - automation / fetch-and-carry → **Doodle**
- Across a multi-image set for one article, do not cast Spark in more than about one shot unless the article is specifically about inventing or launching a product. Prefer rotating the crew.
